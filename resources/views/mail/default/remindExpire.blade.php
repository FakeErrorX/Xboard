                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                Your service will expire within 24 hours. To avoid any service disruption, please renew as soon as possible. If you have already renewed, please ignore this email.
                            </td>
                        </tr>
