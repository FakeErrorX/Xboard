                ...
                <div style="background:#fff">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="padding:40px 40px 0 40px;display:table-cell">
                            <td style="font-size:24px;line-height:1.5;color:#000;margin-top:40px">Login to {{$name}}</td>
                        </tr>
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                You are logging into {{$name}}. Please click the link below within 5 minutes to complete the login. If you did not authorize this login request, please ignore this email.
                                <a href="{{$link}}">{{$link}}</a>
                            </td>
                        </tr>
