...
window.XBOARD_TRANSLATIONS['en-US'] = {
  ...
  "settings": {
    ...
    "invite": {
      ...
      "commission_withdraw_limit": {
        "title": "Withdrawal Threshold (Taka)",
    ...
    "template": {
      ...
      "form": {
        ...
        "rewards": {
          "title": "Rewards",
          "balance": {
            "label": "Reward Balance (Taka)",
            "short_label": "Balance",
            "placeholder": "Please enter reward amount (Taka)"
          },
          "transfer_enable": {
  ...
  "theme": {
    ...
    "description": "Theme configuration, including theme colors, font sizes, etc. If you deploy Xboard in a front-end and back-end separated way, theme configuration will not take effect.",
    "upload": {
      "button": "Upload Theme",
      "title": "Upload Theme",
