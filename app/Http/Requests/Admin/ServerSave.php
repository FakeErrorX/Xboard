...
class ServerSave extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'group_ids.array' => 'Permission group format is incorrect',
            'route_ids.array' => 'Route group format is incorrect',
            ...
            'networkSettings.array' => 'Transport protocol configuration is invalid',
            'ruleSettings.array' => 'Rule configuration is invalid',
            'tlsSettings.array' => 'TLS configuration is invalid',
            'dnsSettings.array' => 'DNS configuration is invalid'
        ];
    }
}
